...
export async function POST(request) {
    ...
    .upsert(
      {
        ...
        total_score: Math.round(payload.progress * payload.sessions_count),
        certified: certification.certified,
        cert_level: certification.cert_level,
        unlocked: true,
  ...
  if (certification.certified && certification.cert_level) {
    await supabase
      .from("certifications")
      .upsert(
        {
          ...
          game_id: payload.game_id,
          earned_at: createdAt,
          exam_score: payload.accuracy,
        },
        { onConflict: "user_id,cert_level,game_id" }
      );
  }
